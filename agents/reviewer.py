...
class Reviewer(BaseAgent):
    """
    TODO: implement _build_system_prompt() and _parse_response().
    ...
    def _build_system_prompt(self) -> str:
        # TODO (session-2): return your system prompt string.
        # See the class docstring above for what to include.
        # See skills/reviewer/criteria.md — your review criteria go there.
        raise NotImplementedError

    def _parse_response(self, response) -> str:
        """
        TODO (session-2): extract the tool_use block from the API response and return
